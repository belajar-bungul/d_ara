...
class DashboardBlock(models.Model):
    ...
    _description = "Dashboard Components"
    ...
    type = fields.Selection(
        selection=[("graph", "Chart"), ("tile", "Card")],
        string="Component Type", help='Type of Block ie, Chart or Card')
    ...
    tile_color = fields.Char(string="Card Color", help='Primary Color of Tile')
